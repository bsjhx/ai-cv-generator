...
with st.sidebar:
    ...
    history = st.text_area("Work Experience", height=150, placeholder="Describe your work history in detail...")
...
job_desc = st.text_area(
    "Target Job Description", placeholder="Paste the job ad here..."
)
        ...
        try:
            with st.spinner("Gemini is crafting your resume..."):
                ...
                sys_msg = SystemMessage(
                    content="""You are a Senior Career Coach. 
